...
<head>
    ...
    <style>
        ...
        input { width: 100%; padding: 0.75rem; margin-bottom: 1.25rem; border: 1px solid #d1d5db; border-radius: 6px; box-sizing: border-box; font-size: 16px; background: #fff; }
        .btn { width: 100%; padding: 0.75rem; background: #10b981; color: white; border: none; border-radius: 6px; font-weight: 600; font-size: 16px; cursor: pointer; display: block; text-align: center; text-decoration: none; box-sizing: border-box; }
        .btn-cancel { background: #f3f4f6; color: #374151; margin-top: 0.75rem; }
    </style>
</head>
<body>
<div class="card">
    <h2 style="margin-top: 0;">Add Calendar Event</h2>
